...
void solve(){
    ...
    if(mindis1+mindis2+mp[portal1.first][portal1.second]+mp[portal2.first][portal2.second]<ans){
        cout<<mindis1+mindis2+mp[portal1.first][portal1.second]+mp[portal2.first][portal2.second];
    }
    else cout<<-1;
}
